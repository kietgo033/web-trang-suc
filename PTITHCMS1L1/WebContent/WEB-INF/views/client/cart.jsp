...
<!-- phần body-->
            ...
            <div class="container">
                ...
                <div class="total">
                    ...
                    <div class="clearfix"> </div>
                    <div class="total_right">Tổng tiền: $<c:out value="${sessionScope.myCartTotal}"/></div>
                    <div class="clearfix"> </div>
                    <div class="total_right">VAT (0%): $<c:out value="${sessionScope.myCartTotal * 0}"/></div>
                    <div class="clearfix"> </div>
                    <div class="total_right">Phải trả: $<c:out value="${sessionScope.myCartTotal + (sessionScope.myCartTotal * 0)}"/></div>
                    <div class="clearfix"> </div>
                </div>
                <div class="login_buttons">
