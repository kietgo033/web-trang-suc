...
<body>
	...
	<div class="container">
		<div class="account">
			<h2 class="account-in">Xin chào ${sessionScope.user.username}:</h2>
			
			<br>
			<span ><u style="color:blue">Họ và tên:</u> ${sessionScope.user.name}</span><br><br>
			<span><u style="color:blue">Email:</u> ${sessionScope.user.email}</span><br><br>
			<span><u style="color:blue">Số điện thoại:</u> ${sessionScope.user.phone}</span><br><br>
			<span><u style="color:blue">Địa chỉ:</u> ${sessionScope.user.address}</span><br><br><br><br>
			<!--  
				<form>
				<div>
				...
				-->
				<a href="client/logout.htm"><input type="submit" value="Đăng xuất"></a>  
				<a href="client/account/changePW.htm"><input type="submit" value="Đổi mật khẩu"></a>  
				<a href="client/account/edit.htm"><input type="submit" value="Chỉnh sửa thông tin cá nhân"></a>  
				<c:if test="${sessionScope.user.userRole=='admin'}">
				<a href="admin/quan-ly.htm"><input type="submit" value="Quản trị"></a>  
				</c:if>
