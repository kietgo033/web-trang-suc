...
<body>
		...
		<div class="slides" id="slides">
			...
			<div class="slide">
				<a href="client/single/47.htm"><img class="sli"
					src="${pageContext.request.contextPath}/resources/client/images/heartof.jpg"
					alt="Heart of the Ocean" /></a>
				<div class="caption">
					<a href="client/single/47.htm" class="purchase-btn">&nbsp;</a>
					<p>
						Dây chuyền Heart of the Ocean - Now Available for just <span
			...
			<div class="slide">
				<a href="client/single/48.htm"><img class="sli"
					src="resources/client/images/đồng hồ 3.jpg" alt="Tissot Powermatic" /></a>
				<div class="caption">
					<a href="client/single/48.htm" class="purchase-btn">&nbsp;</a>
					<p>
						Đồng hồ Tissot Powermatic - Now Available for just <span
			...
			<div class="slide">
				<a href="client/single/50.htm"><img class="sli"
					src="resources/client/images/Moissanite.jpg" alt="Moissanite" /></a>
				<div class="caption">
					<a href="client/single/50.htm" class="purchase-btn">&nbsp;</a>
					<p>
						Nhẫn Moissanite - Now Available for just <span class="price">$400</span>
					</p>
				</div>
				<!-- end of .caption -->
			</div>
			...
			<div class="slide">
				<a href="client/single/51.htm"><img class="sli"
					src="resources/client/images/bong-tai-ngoc-trai.jpg" alt="Ulzzang" /></a>
				<div class="caption">
					<a href="client/single/51.htm" class="purchase-btn">&nbsp;</a>
					<p>
						Bông tai Ulzzang - Now Available for just <span class="price">$200</span>
					</p>
				</div>
				<!-- end of .caption -->
			</div>
	...
	<div class="footer">
		...
		<p class="footer-class">
			Copyright © 2020 Modern by kietgo033 <a
				href="https://www.facebook.com/kietgo033" target="_blank">kietgo033</a>
		</p>
		<script type="text/javascript">
