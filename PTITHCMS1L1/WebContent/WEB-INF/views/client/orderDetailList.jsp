...
<body>
	...
	<div class="container">
		<br> <br>
		<h2 style="text-align: center; color: red">Chi tiết đơn đặt hàng
			của bạn(Mã số hóa đơn:${id})</h2>
		<br>
...
<br><br>
						...
						<a href="${pageContext.request.contextPath}/client/orderList.htm"><button> <u>Quay lại</u></button></a>
