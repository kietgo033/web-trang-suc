    ...
    <body>
        ...
        <div class="header-main">
            <div class="header-left">
                <div class="logo-name">
                    <a href="${pageContext.request.contextPath}/trang-chu.htm"> <h1>KiEtGO</h1> 
                    ...
                    <ul class="nofitications-dropdown">
                        <li class="dropdown head-dpdn">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p4.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Oanh Đoàn</p>
                                            <p><span>18 hour ago</span></p>
                                        </div>
                                        <div class="clearfix"></div>	
                                    </a></li>
                                <li class="odd"><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p2.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Kiệt Phan </p>
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p3.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Đặng An</p>
                        ...
                        <li class="dropdown head-dpdn">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p5.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Order 27</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                                ...
                                <li class="odd"><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p6.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Order 45</p>
                                            <p><span>18 hour ago</span></p>
                                        </div>
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/admin/images/p7.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Order 56</p>
