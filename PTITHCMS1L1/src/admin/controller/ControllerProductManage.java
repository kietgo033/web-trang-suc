...
public class ControllerProductManage {
	...
	public String addProduct(@RequestParam("attachment") MultipartFile photo,ModelMap model, HttpSession session,@ModelAttribute("product") Product product
			) {
...
//		}
		...
		try {
			// String
			// photoPath=request.getSession().getServletContext().getRealPath("/")+"files/";
			// File upload=new
			// File("D:/eclipse/PTITHCMS1L1/WebContent/resources/client/images/"+photo.getOriginalFilename());
